...
class Compare():
    ...
    def __post_init__(self):
        ...
        if "Model 01" in compare or "Model 06" in compare or "Model 08" in compare or "Model 09" in compare or "Model 11" in compare:
            with col2:
        ...
        if "Model 01" in compare or "Model 06" in compare or "Model 07" in compare or "Model 10" in compare or "Model 11" in compare:
            with col1: 
                ExCo = st.radio("Choose Exposure Condition of Component:", ["Indoor", "Outdoor", "Exposed to Rain", "Sheltered from Rain"], key="compare_09")
        if "Model 02" in compare or "Model 08" in compare or "Model 09" in compare:
            with col1:
        ...
        if "Model 02" in compare and choose=="Set Inverse Effective Carbonation Resistance":
            with col2:
        ...
        if "Model 01" in compare or ("Model 02" in compare and choose=="Calculate with Compressive Strenght") or "Model 03" in compare or "Model 04" in compare or "Model 05" in compare or "Model 06" in compare or ("Model 07" in compare and Depending=="Compressive Strength") or "Model 09" in compare or "Model 10" in compare or "Model 11" in compare: 
            with col2:
        ...
        if st.button("Calculate", key=("compare_button")):
            ...
            if "Model 01" in compare:
                Model01 = Häkkinen("Model 01", f_c, ExCo, AirEntrained, C, FA, SF, GGBS)
            ...
            if "Model 02" in compare and choose=="Set Inverse Effective Carbonation Resistance":
                Model02_1 = fib("Model 02", RH, ToW, p_dr, t_c, R_NAC, CO2, t)
            ...
            if "Model 02" in compare and choose=="Calculate with Compressive Strenght":
                Model02_2 = fibGuiglia("Model 02", RH, ToW, p_dr, t_c, f_c, CO2, t)
            ...
            if "Model 03" in compare:
                Model03 = CECS220("Model 03", f_c, FA_c, Stress, Location, T, RH, CO2)
            ...
            if "Model 07" in compare and Depending == "Time":
                Model07_1 = Hills_time("Model 07", mixture, ExCo, Origin, Age)
            ...
            if "Model 08" in compare:
                Model08 = GreveDierfeld("Model 08", RH, Cem, wb, CO2, ToW, p_dr, t_c)
            ...
            if "Model 10" in compare: 
                Model10 = Ekolu("Model 10", f_c, RH, CO2, Cem, ExCo, t)   

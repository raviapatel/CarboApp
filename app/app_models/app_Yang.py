...
class app_Yang():   #Model 06
    ...
    def __post_init__(self):
        ...
        with col2:
            ...
            wb = st.number_input("Water / Binder Ratio: [-]", min_value=(0.0), value=(0.6), max_value=(1.0), step=(0.01))
        ...
        if st.button("Calculate"): 
            Modell06 = Yang(self.name, t, C, S, G, FA, GGBS, SF, wb, RH, CO2, ExCo, Finishing)
